...
namespace PuzzleEngineAlpha.Components.Titles
{
    public class CenteredTitle:Title
    {
        ...
        public override Vector2 TextureLocation
        {
            get
            {
                return new Vector2(Resolution.ResolutionHandler.WindowWidth / 2 - Texture.Width / 2, textureLocation.Y);
            }
        }
        ...
        public override Vector2 TextLocation
        {
            get
            {
                if (ShowTexture)
                    ...
                    return new Vector2(Resolution.ResolutionHandler.WindowWidth / 2 - FontSize.X / 2, -textureLocation.Y);
            }
