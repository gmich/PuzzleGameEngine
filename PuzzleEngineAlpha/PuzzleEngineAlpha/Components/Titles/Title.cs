...
namespace PuzzleEngineAlpha.Components.Titles
{
    public class Title
    {
        ...
        {
            this.TextureLocation = this.TextLocation = new Vector2(Resolution.ResolutionHandler.WindowWidth, 0) - location;
            this.Font = font;
            this.Text = text;
        ...
        public virtual Vector2 TextLocation
        {
            get
            {
                if (ShowTexture)
                    ...
                    return new Vector2(Resolution.ResolutionHandler.WindowWidth, 0) - textLocation;
            }
            set
            {
                textLocation = value;
        ...
        public virtual Vector2 TextureLocation
        {
            get
            {
                return new Vector2(Resolution.ResolutionHandler.WindowWidth, 0) - textureLocation;
            }
            set
            {
