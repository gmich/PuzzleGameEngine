...
namespace EngineTester
{
    ...
    public class GUIElementTest
    {
        ...
        {
            AGUIComponent component = new MenuButton(new DrawProperties(), new DrawProperties(), new DrawProperties(), new DrawTextProperties(), new Vector2(1, 1), new Vector2(3, 3));
